...
public class Shopping_ListII_Scanner {
    /* create a shopping list, count and prices.

Use Scanner and ask user to enter 3 items followed by its count, price and you
will calculate total price and show as a report.
...
*/
    ...
    public static void main(String[] args) {
        ...
        String report ="";
        int itemCount = (count1+count2+count3);
